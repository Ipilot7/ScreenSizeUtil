...
class ScreenSizeUtilInit extends StatefulWidget {
  /// A helper widget that initializes [ScreenUtil]
  const ScreenSizeUtilInit(
      {Key? key,
  ...
  @override
  State<ScreenSizeUtilInit> createState() => _ScreenSizeUtilInitState();
}

class _ScreenSizeUtilInitState extends State<ScreenSizeUtilInit>
